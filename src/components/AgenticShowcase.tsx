  ...
  return (
    <section id="agentic" className="py-24 md:py-36 relative">
      <div className="max-w-5xl mx-auto px-6 sm:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 dark:text-emerald-300 text-xs font-semibold uppercase tracking-wider mb-4 shadow-sm">
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      {item.hasSkillModal && (
                        <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-800 dark:text-amber-300 text-[11px] font-medium animate-pulse">
                          <FileCode2 className="w-3 h-3" />
                          <span>.md Skill</span>
                        </span>
                      )}
                      {item.hasRuleModal && (
                        <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-800 dark:text-emerald-300 text-[11px] font-medium animate-pulse">
                          <FileCode2 className="w-3 h-3" />
                          <span>.md Rule</span>
                        </span>
                      )}
                      {item.hasWebpModal && (
                        <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-800 dark:text-cyan-300 text-[11px] font-medium animate-pulse">
                          <FileCode2 className="w-3 h-3" />
                          <span>.md Skill</span>
                        </span>
                      )}
                      <span className="px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 dark:text-emerald-300 text-xs font-mono-custom font-semibold">
                        {item.impact}
                      </span>
                    </div>
                  </div>
                ...
                <div className="mt-8 pt-4 border-t border-[var(--border-subtle)] flex flex-wrap items-center justify-between gap-3 text-xs font-mono-custom">
                  ...
                  {item.hasSkillModal && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-amber-900 dark:text-amber-300 bg-amber-500/10 dark:bg-amber-500/15 hover:bg-amber-500/20 border border-amber-500/30 transition-all group-hover:scale-105 shadow-sm cursor-pointer"
                    >
                  ...
                  {item.hasRuleModal && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-emerald-900 dark:text-emerald-300 bg-emerald-500/10 dark:bg-emerald-500/15 hover:bg-emerald-500/20 border border-emerald-500/30 transition-all group-hover:scale-105 shadow-sm cursor-pointer"
                    >
                  ...
                  {item.hasWebpModal && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-indigo-900 dark:text-cyan-300 bg-cyan-500/10 dark:bg-cyan-500/15 hover:bg-cyan-500/20 border border-cyan-500/30 transition-all group-hover:scale-105 shadow-sm cursor-pointer"
                    >
